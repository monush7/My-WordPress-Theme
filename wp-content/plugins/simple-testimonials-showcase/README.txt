...
Donate link: http://presstigers.com
Tags: clients Feedback, grid layout, publish feedback, quote-layout-testimonials, quotes, testify, testimonials, testimonials management
...
The manual installation method involves downloading our Testimonials Showcase plugin and uploading it to your webserver via your favourite FTP application. The WordPress codex contains [instructions on how to do this here](https://codex.wordpress.org/Managing_Plugins#Manual_Plugin_Installation).
...
1. **Add New** - Add new testimonial & fill details of it.
2. **Edit Testimonial** - User can edit any kind of detail of testimonial.
3. **Testimonials** - List of added testimonials for admin site.
4. **Shortcode Builder Icon** - Click on the highlighted icon to generate testimonials shortcode.
5. **Shortcode Builder Form** - User can add shortcode in page/post after specifying required values in form.
6. **Settings** - Users can change color options of Simple Testimonials Showcase on front end.
7. **Layout Quote** - User can display testimonials in form of quote layout.
8. **Layout Grid** - User can also display testimonials in form of grid layout.

== Upgrade Notice ==

= 1.1.4 =
1.1.4 is a minor release with WP 5.5 compatability.