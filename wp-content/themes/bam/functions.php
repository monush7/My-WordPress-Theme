...
final class Bam_Theme {
	...
	private function includes() {
		...
		require_once( $dir . 'class-bam-walker-page.php' );
		...
		require_once( $dir . 'wptt-webfont-loader.php' );
	...
	public function register_scripts() {
		...
		wp_enqueue_script( 'bam-main', $dir_uri . 'js/main.js', array(), $theme_version, true );
